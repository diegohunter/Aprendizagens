...
{
    public abstract class ExcelProxyAbstract<TWorkbook, TApp, TSheet> : IDisposable where TWorkbook : class 
    {
        ...
        public abstract ICollection<TSheet> GetSheets(TWorkbook workbook);
                ...
                if (workBook != null)
                {
                    ...
                    if (findAllSheets)
                    {
                        if(lstSheet != null)
                        {
                            ...
                            {
                                ToDTO<T>((TSheet)sheet, lstRetorno, limitTo);
                            }
                        }
                    }
                    else
        ...
        public abstract void ToDTO<T>(TSheet sheet, ICollection<T> lstDTO, int limitTo = -1);
        

        private bool SetValueOnDTO<T>(T dto, string property, object value)
        {
